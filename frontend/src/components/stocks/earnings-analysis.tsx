...
import { FileSpreadsheet, ChevronDown, Loader2, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        ...
        {s?.surprise && (
          <Badge variant="outline" className="capitalize">Surprise: {s.surprise}</Badge>
        )}
        {s?.confidence && (
...
export function EarningsBreakdownPanel({ symbol }: { symbol: string }) {
      ...
      <CardContent>
        {!displayed && !generateMut.isPending && !generateMut.isError && (
          <div className="space-y-2 text-sm text-muted-foreground">
            ...
            <p>Revenue and profit vs expectations, key metrics, guidance, and market reaction — never inventing beats/misses.</p>
