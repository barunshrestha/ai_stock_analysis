  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        ...
        {s?.outlook_band && (
          <Badge variant="outline" className="capitalize">Outlook: {s.outlook_band}</Badge>
        )}
        {s?.confidence && (
...
export function GrowthPotentialPanel({ symbol }: { symbol: string }) {
      ...
      <CardContent>
        {!displayed && !generateMut.isPending && !generateMut.isError && (
          <div className="space-y-2 text-sm text-muted-foreground">
            ...
            <p>Market size context, industry growth, expansion, products, and tech/AI advantages — without inventing TAM figures.</p>
